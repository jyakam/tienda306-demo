...
const COLUMNAS\_VALIDAS = \[
'FECHA\_PRIMER\_CONTACTO',
'FECHA\_ULTIMO\_CONTACTO',
'TELEFONO',
'NOMBRE',
'RESP\_BOT',
'IDENTIFICACION',
...
const contactoExistente = CONTACTOS.LISTA\_CONTACTOS.find(c => c.TELEFONO === phone) || {}
const contactoFinal = {
TELEFONO: phone,
RESP\_BOT: contactoExistente.RESP\_BOT || 'Sí',
...
'IDENTIFICACION', 'TIPO DE CLIENTE', 'RESUMEN\_ULTIMA\_CONVERSACION'
]
...
COLUMNAS\_VALIDAS.includes(key) &&
(
...
await ActualizarFechas(phone)
const contactoConFechas = CONTACTOS.LISTA\_CONTACTOS.find(c => c.TELEFONO === phone)
if (contactoConFechas) {
if (contactoConFechas.FECHA\_PRIMER\_CONTACTO) {
contactoLimpio.FECHA\_PRIMER\_CONTACTO = contactoConFechas.FECHA\_PRIMER\_CONTACTO
}
if (contactoConFechas.FECHA\_ULTIMO\_CONTACTO) {
contactoLimpio.FECHA\_ULTIMO\_CONTACTO = contactoConFechas.FECHA\_ULTIMO\_CONTACTO
}
}
...
try {
console.log(`📤 Enviando a postTable:`, { table: process.env.PAG\_CONTACTOS, data: \[contactoLimpio], propiedades })
const resp = await postTableWithRetry(APPSHEETCONFIG, process.env.PAG\_CONTACTOS, \[contactoLimpio], propiedades)
